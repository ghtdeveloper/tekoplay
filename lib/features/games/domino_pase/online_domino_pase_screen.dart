...
class _OnlineDominoPaseScreenState extends State<OnlineDominoPaseScreen>
                    ...
                    children: [
                      ...
                      if (opp.isActive && _opponentTimer != null) ...[
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: _opponentSecondsLeft <= 15 ? Colors.red[300] : Colors.orange[300],
                            fontSize: 9,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
  ...
  Widget _buildGameOverOverlay(DominoGameMatch game) {
    ...
    final totalResult = iWon ? (winnerPrize - required + myPassNet) : (-required + myPassNet);
          ...
          children: [
            ...
            if (!game.isAbandoned && !rematchFailed && !someoneLeft) ...[
              SizedBox(
                width: double.infinity,
                child: ElevatedButton.icon(
                  onPressed: _waitingForRematch ? null : _requestRematch,
                  icon: Icon(_rematchRequested ? Icons.hourglass_top : Icons.replay, size: 18),
                  label: Text(
                    _waitingForRematch
                        ? 'Creando revancha...'
                        : _rematchRequested
